...
public class JogoTeste {
	...
	public void deveTerJogoComUnicoParticipante() {
		...
		jogo.anota(new Resultado(new Participante("Leonardo"), 150, 0));
	...
	public void deveTerVariosResultados() {
        ...
        .para("Cata moedas")
        .resultado(new Participante("Nelson"), 150.0, 0)
        .resultado(new Participante("Pedro"), 200.0, 0)
        .constroi();
	...
	public void naoDeveAceitarDoisResultadosDoMesmoParticipante(){
		...
		jogo.anota(new Resultado(leonardo, 500.0, 0));
		//deve ser ignorado
		jogo.anota(new Resultado(leonardo, 600.0, 0));
